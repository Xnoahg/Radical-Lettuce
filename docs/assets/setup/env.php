...
if (!defined('DB_PASSWORD'))                    define('DB_PASSWORD' ,'PeaPi3.14');
if (!defined('DB_PORT'))                        define('DB_PORT' ,'');

if (!defined('MAIL_HOST'))                      define('MAIL_HOST', 'smtp.gmail.com');
if (!defined('MAIL_USERNAME'))                  define('MAIL_USERNAME', 'radicallettuceoniline@gmail.com');
if (!defined('MAIL_PASSWORD'))                  define('MAIL_PASSWORD', 'ocus korn kwcz hcsc');
